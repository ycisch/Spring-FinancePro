  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="类型" prop="financeType">
        <el-select clearable v-model="queryParams.financeType" filterable placeholder="请选择">
    ...
    <el-table v-loading="loading" :data="financeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="结账记录" align="center" width="180">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleShowRecord(scope.row)"
            v-hasPermi="['system:finance:edit']">查看</el-button>
        </template>
      </el-table-column>
